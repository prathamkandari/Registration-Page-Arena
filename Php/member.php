...
if (isset($_POST['next'])) {
    ...
    if ($game_option == "BGMI") {
        ...
        $insert_m1_details = "INSERT INTO m1_details VALUES ('$m1_name', '$m1_email','$m1_id','$m1_rank', '$m1_contact', '$m1_sap', '$m1_college' ,'$t_name')";
        ...
        if ($team_size > 2) {
            ...
            $insert_m2_details = "INSERT INTO m2_details VALUES ('$m2_name', '$m2_email','$m2_id','$m2_rank', '$m2_contact', '$m2_sap', '$m2_college' ,'$t_name')";
            ...
            if ($team_size == 4) {
                ...
                $insert_m3_details = "INSERT INTO m3_details VALUES ('$m3_name', '$m3_email','$m3_id','$m3_rank', '$m3_contact', '$m3_sap', '$m3_college' ,'$t_name')";
        ...
        if (check_Registration($registered_successfully)) {
            ...
            header("Location: ../html/transaction.html?game=".urlencode($game_option));
        ...
        $insert_m4_details = "INSERT INTO m4_details VALUES ('$m4_name', '$m4_email', '$m4_id','$m4_rank','$m4_contact', '$m4_sap', '$m4_college','$t_name')";
